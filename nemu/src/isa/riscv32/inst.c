...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, R(rd) = ((int64_t)((int32_t)src1 * (int32_t)src2)) >> XLEN);
  INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu , R, R(rd) = ((int64_t)((int32_t)src1 * src2)) >> XLEN);
  INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulsu  , R, R(rd) = ((uint64_t)(src1 * src2)) >> XLEN);
  ...
  INSTPAT("0000001 ????? ????? 101 ????? 01100 11", remu   , R, R(rd) = src1 % src2);
